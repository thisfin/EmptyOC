...
- (void)colorButtonClicked:(NSButton *)sender {
    switch (sender.tag) {
        case 0:
//            NSColor *a = NSColor.greenColor;
//            NSColor *fontColor = NSColor.greenColor;
//            NSColor *backFontColor = [fontColor colorWithAlphaComponent:0.08];
//            _textField.textColor = fontColor;
//            _backTextField.textColor = backFontColor;
